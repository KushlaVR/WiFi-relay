...
void WebUIController::setup(Timezone * timeZone)
{
	this->timeZone = timeZone;
	
	ssdp(wifiController.getAPName().c_str());
...
void WebUIController::ssdp(const char * deviceName)
{
...
{
	if (!WebUIController::isIp(webServer.hostHeader()) && webServer.hostHeader() != (wifiController.getAPName() + ".local")) {
