...
int Timezone::weekNum(String weekName)
{
	weekName.trim();
	weekName.toLowerCase();
	if (weekName == "last") return Last;
	if (weekName == "first") return First;
	if (weekName == "second") return Second;
	if (weekName == "third") return Third;
	if (weekName == "fourth") return Fourth;
}

int Timezone::dayNum(String dayName)
{
	dayName.trim();
	dayName.toLowerCase();
	if (dayName == "sun") return Sun;
	if (dayName == "mon") return Mon;
	if (dayName == "tue") return Tue;
	if (dayName == "wed") return Wed;
	if (dayName == "thu") return Thu;
	if (dayName == "fri") return Fri;
	if (dayName == "sat") return Sat;

}

int Timezone::monthNum(String monthName)
{
	monthName.trim();
	monthName.toLowerCase();
	if (monthName == "jan") return Jan;
	if (monthName == "feb") return Feb;
	if (monthName == "mar") return Mar;
	if (monthName == "apr") return Apr;
	if (monthName == "may") return May;
	if (monthName == "jun") return Jun;
	if (monthName == "jul") return Jul;
	if (monthName == "aug") return Aug;
	if (monthName == "sep") return Sep;
	if (monthName == "oct") return Oct;
	if (monthName == "nov") return Nov;
	if (monthName == "dec") return Dec;
}

String Timezone::FormatTime(time_t time)
{
	long h = hour(time);
	int m = minute(time);
	int s = second(time);
...
String Timezone::FormatDate(time_t time)
{
	long y = year(time);
	int m = month(time);
	int d = day(time);
